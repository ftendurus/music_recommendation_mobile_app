...
import 'package:music_recommendation_with_emotional_analysiss/pages/recomendation%20pages/select_language.dart';
              ...
              Row(
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsets.only(right: 36, left: 6, top: 10),
                      child: StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, AsyncSnapshot snapshot) {
                          ...
                          return Container(
                            height: 70 * itemCount.toDouble() + 32,
                            child: Column(
                              children: [
                                ListView.builder(
                                  shrinkWrap: true,
